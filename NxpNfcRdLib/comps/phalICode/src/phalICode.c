 ...
 *								0x02: PHAL_ICODE_PROTECT_PAGE_WRITE_PASSWORD
 *								0x03: PHAL_ICODE_PROTECT_PAGE_READ_WRITE_PASSWORD_SEPERATE
 *
 * Return:
 *			PH_ERR_SUCCESS for successfull operation.
 *			Other Depending on implementation and underlaying component.
 */
phStatus_t phalICode_ProtectPage(void * pDataParams, uint8_t bPageNo, uint8_t bProtectionStatus)
{
    phStatus_t PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
        wStatus = phalICode_Sw_ProtectPage((phalICode_Sw_DataParams_t *) pDataParams, bPageNo, bProtectionStatus);
        break;
#endif /* NXPBUILD__PHAL_SLI_SW */
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
        wStatus = phalICode_Sw_Destroy((phalICode_Sw_DataParams_t *) pDataParams);
        break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 *
 * Output Parameters:
 *		ppData				: Information received from VICC.
 *		pDataLen			: Number of received data bytes.
 *
 * Return:
 *			PH_ERR_SUCCESS for successfull operation.
 *			Other Depending on implementation and underlaying component.
 */
phStatus_t phalICode_ReadSRAM (void * pDataParams, uint8_t bOption, uint8_t bBlockNo, uint8_t bNumBlocks, uint8_t ** ppData, uint16_t * pDataLen)
{
    phStatus_t PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
        wStatus = phalICode_Sw_ReadSRAM((phalICode_Sw_DataParams_t *) pDataParams, bOption, bBlockNo, bNumBlocks, ppData, pDataLen);
        break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 *			Other Depending on implementation and underlaying component.
 */
phStatus_t phalICode_WriteSRAM (void * pDataParams, uint8_t bBlockNo, uint8_t bNumBlocks, uint8_t * pData, uint16_t wDataLen)
{
    phStatus_t PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
        wStatus = phalICode_Sw_WriteSRAM((phalICode_Sw_DataParams_t *) pDataParams, bBlockNo, bNumBlocks, pData, wDataLen);
        break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
