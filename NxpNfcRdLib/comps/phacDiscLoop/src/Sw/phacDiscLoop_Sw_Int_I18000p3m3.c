        ...
        while(wIndex < wRxBufferLen)
        {
            if(pRxBuffer[wIndex] == 0U)
            {
                ...
                if(pRxBuffer[wIndex + 1U] > (bPcLength + bPacketCrcLen))
                {
                    ...
                    if((pRxBuffer[wIndex + 1U] - (bPcLength + bPacketCrcLen)) <= sizeof(pDataParams->sI18000p3m3TargetInfo.aI18000p3m3[pDataParams->bNumOfCards].aUii))
                    {
                        /* Copy UII */
                        (void)memcpy(
                        ...
                        pDataParams->sI18000p3m3TargetInfo.aI18000p3m3[pDataParams->bNumOfCards].wUiiLength =
                            (uint16_t)((pRxBuffer[wIndex + 1U] - (bPcLength + bPacketCrcLen)) * 8U);
                    }
                    else
                    {
