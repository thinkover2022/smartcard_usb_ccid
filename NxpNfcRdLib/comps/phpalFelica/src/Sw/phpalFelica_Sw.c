                               ...
                               )
{
    ...
    else
    {
        ...
        wTimeOutUs = FDTF_LISTEN_SENSF_REQ(bNumTimeSlots + 1U) - wTR1ValueUs + PHPAL_FELICA_SW_T_DELTA_F_POLL_US;
    }
    ...
    else
    {
        ...
        /* Store IDm and PMm */
        (void)memcpy(pDataParams->aIDmPMm, &pRxBufferTmp[2], (pRxBufferTmp[0] - 2));
