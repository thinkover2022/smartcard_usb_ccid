...
#define PHHAL_HW_CLRC663PLUS_PRODUCT_ID    0x0100U   /**< Product ID for RC663 Plus. */
/*@}*/

/** \name RC663 Version
*/
/*@{*/
#define PHHAL_HW_CLRC663PLUS_VERSION        0x1AU   /**< Version of RC663 Plus. Refer VERSION Register (Address : 0x7F) for more information. */
/*@}*/

/** \name Position and Mask of Version and Derivative in variable dwDerivative of structure phhalHw_Rc663_DataParams_t.
 */
/*@{*/
#define PHHAL_HW_VERSION_POS                16U
#define PHHAL_HW_VERSION_MASK               0x00FF0000U
#define PHHAL_HW_DERIVATIVE_POS             0U
#define PHHAL_HW_DERIVATIVE_MASK            0x0000FFFFU
/*@}*/
