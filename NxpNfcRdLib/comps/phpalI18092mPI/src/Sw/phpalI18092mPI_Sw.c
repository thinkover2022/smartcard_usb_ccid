    ...
    do
    {
        ...
        if ((status & PH_ERR_MASK) == PH_ERR_SUCCESS)
        {
            ...
            *pAtrResLength = (uint8_t)wFrameLength;
            ...
            dwRwt = PHPAL_I18092MPI_SW_RWT_MIN_US * (((uint32_t)1U << bTo));
                                 ...
                                 )
{
    ...
    /* Calculate Response Waiting Time. */
    dwTimeout = (uint32_t)(PHPAL_I18092MPI_SW_RWT_MIN_US * ((uint32_t)(1U << pDataParams->bWt)));
                                       ...
                                       )
{
    ...
    case PHPAL_I18092MPI_CONFIG_ATN:
        *pValue = (uint16_t)(pDataParams->bAtnDisabled ^ 0x01U);
        break;
