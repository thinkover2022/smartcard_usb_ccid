...
phStatus_t phNfcLib_ISO15693_Transmit(void * const pTxBuffer, uint16_t wTxBufferLength)
{
    ...
    case ISO15693_Extended_ReadMultipleBlocks:
        ...
        /* Check number of blocks doesn't exceed 256 */
        if ((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO15693.wBlockNumber + ((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO15693.wNumBlocks) >= 0x10000U)
        {
            return PH_ERR_INVALID_PARAMETER;
        }
    ...
    case ISO15693_Extended_WriteMultipleBlocks:
        ...
        /* Check number of blocks doesn't exceed 256 */
        if (((uint16_t)((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO15693.wBlockNumber + ((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO15693.wNumBlocks) >= 0x10000U)
        {
            return PH_ERR_INVALID_PARAMETER;
        }
