...
phStatus_t phNfcLib_ISO18000_Transmit(void * const pTxBuffer, uint16_t wTxBufferLength)
{
    ...
    (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.wUiiMaskLength % 8U) ? (bUiiMaskBytes = (((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.wUiiMaskLength)/8U) + 1U)) : (bUiiMaskBytes = (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.wUiiMaskLength)/8U);
    ...
    case ISO18000_Read:
        ...
        if (((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bWordCount != 0x00U) &&
            (gphNfcLib_State.wRxLength != ((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bWordCount << 1U) + 3U))) ||
            (wRxLastBits != 1U) || (gphNfcLib_State.pRxBuffer[0] & 0x80U))
        {
            return PH_ERR_PROTOCOL_ERROR;
        }
    ...
    case ISO18000_Write:
        ...
        /* Check header bit */
        if ((gphNfcLib_State.wRxLength != 3U) || (wRxLastBits != 1U) || (gphNfcLib_State.pRxBuffer[0] & 0x80U))
        {
            return PH_ERR_PROTOCOL_ERROR;
        }
    ...
    case ISO18000_Kill:
        ...
        */
        ...
        if ((gphNfcLib_State.wRxLength != 3U) ||
            (wRxLastBits != 1U) ||
            (gphNfcLib_State.pRxBuffer[0] & 0x80U))
        {
            return PH_ERR_PROTOCOL_ERROR;
        }
    ...
    case ISO18000_BlockPermaLock:
        ...
        {
            if (gphNfcLib_State.wRxLength != (3u + (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bBlockRange << 1U)))
            {
                return PH_ERR_PROTOCOL_ERROR;
            }
        }
