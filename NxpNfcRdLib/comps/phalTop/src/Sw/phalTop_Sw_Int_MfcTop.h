...
#define PH_ALMFCTOP_MFC_READ        0x30U    /**< MIFARE Classic Read command byte */
...
*/
/*@{*/
#define PHAL_MFCTOP_BLOCK_SIZE                     0x10U       /**< Size of a Mifare Claasic Block */
...
phStatus_t phalMfcTop_Sw_Reset(
                            phalTop_Sw_DataParams_t * pDataParams
                            );

phStatus_t phalMfcTop_Sw_SetConfig(
                                phalTop_Sw_DataParams_t * pDataParams,
                                uint16_t wConfig,
                                uint16_t wValue
                                );
