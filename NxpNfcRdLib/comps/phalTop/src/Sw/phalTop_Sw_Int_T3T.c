                                        ...
                                        )
{
    ...
    {
        pT3T->pAlT3TDataParams = pDataParams->pTopTagsDataParams[pDataParams->bTagType - 1];
    }
    else
    {
                                       ...
                                       )
{
    ...
    *pLength = 0;
    ...
    if(0U != (wNdefLength % (bBlocksPerRead * PHAL_TOP_T3T_BLOCK_SIZE)))
    {
        wReadCount += 1U;
    }

    wIndex = 0;
    for(wDataIndex = 0; wIndex < wReadCount; wIndex++)
    {
                                        ...
                                        )
{
  ...
  /* Reset NDEF length */
    ...
    if(0U != (wLength % (bBlocksPerWrite * PHAL_TOP_T3T_BLOCK_SIZE)))
    {
        wWriteCount += 1U;
    }
