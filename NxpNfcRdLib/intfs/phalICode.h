 ...
 *   the command.
 */
#define PHAL_ICODE_FLAG_FAST_DATA_RATE                                  0x80U   /**< RFU as per ISO15693 but this flag should be utilized for PLUTUS product only. This flag is used to
...
/** \name ProtectPage Protection Status options. */
/* @{ */
 ...
 */
#define PHAL_ICODE_PROTECT_PAGE_WRITE_PASSWORD                          0x02U    /**< Option to indicate protection status as
 *      \arg 32-bit Password Protection: Write protection by Read password.
 *      \arg 64-bit Password Protection: Write protection by Read plus Write password.
 */
#define PHAL_ICODE_PROTECT_PAGE_READ_WRITE_PASSWORD_SEPERATE            0x03U    /**< Option to indicate protection status as
...
#define PHAL_ICODE_PARAMETERS_TIMING_106_5_US                           0x01U    /**< Option to indicate that VICC supports 160.5us timing only. */
...
#define PHAL_ICODE_TAG_TYPE_ICODE_PLUTUS                                0x5801U  /**< Option to Get the tag type as ICode Plutus. */
/* @} */
...
#define phalICode_ProtectPage(pDataParams, bPageNo, bProtectionStatus) \
		phalICode_Sw_ProtectPage((phalICode_Sw_DataParams_t *)pDataParams, bPageNo, bProtectionStatus)
...
#define phalICode_Destroy(pDataParams) \
		phalICode_Sw_Destroy((phalICode_Sw_DataParams_t *)pDataParams)
...
#define  phalICode_ParameterSelect(pDataParams, bBitRate, bTiming) \
		phalICode_Sw_ParameterSelect(p(phalICode_Sw_DataParams_t *)DataParams, bBitRate, bTiming)

#define phalICode_ReadSRAM(pDataParams, bOption, bBlockNo, bNumBlocks, ppData, pDataLen) \
		phalICode_Sw_ReadSRAM((phalICode_Sw_DataParams_t *)pDataParams, bOption, bBlockNo, bNumBlocks, ppData, pDataLen)

#define phalICode_WriteSRAM(pDataParams, bBlockNo, bNumBlocks, pData, wDataLen) \
		phalICode_Sw_WriteSRAM((phalICode_Sw_DataParams_t *)pDataParams, bBlockNo, bNumBlocks, pData, wDataLen)
...
phStatus_t phalICode_ProtectPage(
        ...
        uint8_t bProtectionStatus												/**< [In] New protection status;
...
/**
 * \brief Performs Parameter Request command. When receiving VICC PARAMETER REQUEST, PLUTUS returns all supported bit rates
...
phStatus_t phalICode_ParameterRequest(
         ...
         *			\arg #PHAL_ICODE_PARAMETERS_TIMING_106_5_US
...
phStatus_t phalICode_GetTagType(
         ...
         *			\arg #PHAL_ICODE_TAG_TYPE_ICODE_PLUTUS
         */
);
